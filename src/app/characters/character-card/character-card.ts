    ...
    >
      ...
      <div class="relative overflow-hidden">
        ...
        <button
          ...
          class="absolute top-3 right-3 flex h-10 w-10 items-center justify-center rounded-full bg-white/90 backdrop-blur-sm transition-all hover:bg-white hover:scale-110 active:scale-95 dark:bg-slate-800/90 dark:hover:bg-slate-800"
